...
#     )
#
#     manager: ConnectionManager = request.app.state.socket_manager
#     message_data = {
#         'sender_id': str(current_user.id),
#         'recipient_id': str(message.recipient_id),
#         'content': message.content,
#     }
#     await manager.send_json_message(message_data, str(message.recipient_id))
#     await manager.send_json_message(message_data, str(current_user.id))
#
#     return JSONResponse(
#         status_code=201,
